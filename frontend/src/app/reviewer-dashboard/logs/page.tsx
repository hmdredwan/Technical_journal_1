...
export default function ReviewLogsContent({ assignments = [] }: { assignments: Assignment[] }) {
  // Safe filters (optional chaining is still good practice)
      ...
      {assignments.length === 0 ? (
        <div className="bg-white rounded-2xl shadow p-10 text-center">
          ...
          <p className="text-gray-600">
            You haven't completed or been assigned any reviews yet.
          </p>
        </div>
      ) : (
        <>
