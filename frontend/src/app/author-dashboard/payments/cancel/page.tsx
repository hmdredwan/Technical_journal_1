      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="bg-white rounded-2xl shadow border p-8">
          <div className="flex items-start gap-4">
            <AlertTriangle className="text-amber-600" size={42} />
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Payment Cancelled</h1>
              <p className="text-gray-600 mt-2">
                You cancelled the payment. You can restart the payment anytime from the Payments page.
              </p>
            </div>
          </div>
